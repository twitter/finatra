...
import com.twitter.finatra.validation.TimeGranularityValidator._
import java.util.concurrent.TimeUnit
import java.util.concurrent.TimeUnit._
import org.joda.time.{DateTime, DateTimeZone}

private[validation] object TimeGranularityValidator {
 ...
 */
private[validation] class TimeGranularityValidator(
