...
package object validation {
  type CountryCode =
    com.twitter.finatra.json.internal.caseclass.validation.validators.CountryCodeInternal @param
  type FutureTime =
    com.twitter.finatra.json.internal.caseclass.validation.validators.FutureTimeInternal @param
  ...
  type NotEmpty =
    com.twitter.finatra.json.internal.caseclass.validation.validators.NotEmptyInternal @param
  type OneOf =
    com.twitter.finatra.json.internal.caseclass.validation.validators.OneOfInternal @param
  type PastTime =
    com.twitter.finatra.json.internal.caseclass.validation.validators.PastTimeInternal @param
  type Range =
    com.twitter.finatra.json.internal.caseclass.validation.validators.RangeInternal @param
