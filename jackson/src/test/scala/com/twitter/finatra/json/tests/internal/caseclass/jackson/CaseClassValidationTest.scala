...
import com.twitter.finatra.json.tests.internal.caseclass.jackson.domain.{Address, Car, Person}
import com.twitter.finatra.validation.ValidationResult.Invalid
import com.twitter.finatra.validation.{MinInternal, NotEmptyInternal}
