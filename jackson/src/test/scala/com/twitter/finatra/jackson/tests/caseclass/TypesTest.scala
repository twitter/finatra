...
class TypesTest extends Test {
  ...
  test("types#all types") {
    ...
    classOf[java.lang.Byte].isAssignableFrom(Types.wrapperType(java.lang.Byte.TYPE)) should be(
      true)
    ...
    classOf[java.lang.Long].isAssignableFrom(Types.wrapperType(java.lang.Long.TYPE)) should be(
      true)
    ...
    classOf[java.lang.Void].isAssignableFrom(Types.wrapperType(java.lang.Void.TYPE)) should be(
      true)
  }
}
