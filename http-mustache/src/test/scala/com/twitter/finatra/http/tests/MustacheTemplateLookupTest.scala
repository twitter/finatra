...
import com.twitter.finatra.http.marshalling.{
  ...
  MustacheTemplate,
  MustacheTemplateLookup
}
import com.twitter.inject.Test

class MustacheTemplateLookupTest extends Test {

  private final val htmlContentType = "text/html; charset=utf-8"
  private final val jsonContentType = "application/json; charset=utf-8"
  ...
  val noAnnotationView: NoAnnotation.type = NoAnnotation
  ...
  test(
    ...
    intercept[IllegalArgumentException] {
      ...
      s"Object ${noAnnotationView.getClass.getCanonicalName} has no Mustache annotation")
  }
  test(
