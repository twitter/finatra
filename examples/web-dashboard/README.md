...
$ java -jar -Dlog.service.output=web-dashboard.log -Dlog.access.output=access.log examples/web-dashboard/target/scala-2.11/web-dashboard-assembly-2.9.0-SNAPSHOT.jar -http.port=:8888 -admin.port=:9990
```
