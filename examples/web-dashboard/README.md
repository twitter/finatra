...
```
$ sbt assembly
$ java -jar -Dlog.service.output=web-dashboard.log -Dlog.access.output=access.log target/scala-2.11/finatra-web-dashboard-assembly-2.4.0.jar -http.port=:8888 -admin.port=:9990
```
