...
$ java -jar -Dlog.service.output=hello-world.log -Dlog.access.output=access.log examples/hello-world/target/scala-2.11/hello-world-assembly-2.9.0-SNAPSHOT.jar -http.port=:8888 -admin.port=:9990
```
