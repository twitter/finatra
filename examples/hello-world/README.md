...
```
$ sbt assembly
$ java -jar -Dlog.service.output=hello-world.log -Dlog.access.output=access.log target/scala-2.11/hello-world-assembly-2.7.0.jar -http.port=:8888 -admin.port=:9990
```
...
$ java -jar -Dlog.service.output=hello-world.log -Dlog.access.output=access.log examples/hello-world/target/scala-2.11/hello-world-assembly-2.7.0-SNAPSHOT.jar -http.port=:8888 -admin.port=:9990
```
