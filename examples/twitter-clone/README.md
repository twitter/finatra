...
```
[finatra] $ cd ../../
[finatra] $ ./sbt "project twitterClone" "run -http.port=:8888 -admin.port=:9990 -firebase.host=finatra.firebaseio.com -com.twitter.server.resolverMap=firebase=finatra.firebaseio.com:443"
```
...
[finatra] $ java -jar examples/twitter-clone/target/scala-2.XX/twitter-clone-assembly-X.XX.X.jar -http.port=:8888 -admin.port=:9990 -firebase.host=finatra.firebaseio.com -com.twitter.server.resolverMap=firebase=finatra.firebaseio.com:443
```
