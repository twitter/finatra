...
```
$ sbt assembly
$ java -jar -Dlog.service.output=twitter-clone.log -Dlog.access.output=access.log target/scala-2.11/twitter-clone-assembly-2.10.0.jar -http.port=:8888 -admin.port=:9990 -firebase.host=finatra.firebaseio.com -com.twitter.server.resolverMap=firebase=finatra.firebaseio.com:443
```
...
$ java -jar -Dlog.service.output=twitter-clone.log -Dlog.access.output=access.log examples/twitter-clone/target/scala-2.11/twitter-clone-assembly-2.10.0.jar -http.port=:8888 -admin.port=:9990
```
