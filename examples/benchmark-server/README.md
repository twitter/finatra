...
```
$ sbt assembly
$ java -jar target/scala-2.11/finatra-benchmark-server-assembly-2.8.0.jar -http.port=:8888 -admin.port=:9990
```
...
$ java -jar examples/benchmark-server/target/scala-2.11/benchmark-server-assembly-2.9.0-SNAPSHOT.jar -http.port=:8888 -admin.port=:9990
```
