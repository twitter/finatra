...
$ java -jar -Dlog.service.output=java-server.log examples/java-server/target/scala-2.11/java-server-assembly-2.9.0-SNAPSHOT.jar -http.port=:8888 -admin.port=:9990
```
