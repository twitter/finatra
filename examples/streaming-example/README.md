...
```
$ sbt assembly
$ java -jar target/scala-2.11/streaming-example-assembly-2.10.0.jar -http.port=:8888 -admin.port=:9990
```
...
$ java -jar examples/streaming-example/target/scala-2.11/streaming-example-assembly-2.10.0-SNAPSHOT.jar -http.port=:8888 -admin.port=:9990
```
