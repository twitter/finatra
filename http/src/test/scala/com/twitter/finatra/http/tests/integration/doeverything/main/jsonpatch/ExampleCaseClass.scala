...
case class InnerSeqCaseClass(bears: Seq[String])
case class NestedSeqCaseClass(animalFamilies: Seq[AnimalFamily])
case class AnimalFamily(name: String, animals: Seq[String])
