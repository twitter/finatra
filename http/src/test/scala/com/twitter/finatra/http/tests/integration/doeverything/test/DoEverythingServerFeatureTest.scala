...
class DoEverythingServerFeatureTest extends FeatureTest {
  ...
  test("JsonPatch fails when out of bound indices are input for test") {
    ...
    server.httpRequestJson[JsonNode](
      request = request,
      andExpect = BadRequest,
      withJsonBody = """{"errors":["invalid target for test operation, array index out of bounds"]}""")
  }
  ...
  test("JsonPatch fails when out of bound indices are input for replace") {
    ...
    server.httpRequestJson[JsonNode](
      request = request,
      andExpect = BadRequest,
      withJsonBody = """{"errors":["invalid target for replace operation, array index out of bounds"]}""")
  }
  ...
  test("JsonPatch fails when out of bound indices are input for copy") {
    ...
    server.httpRequestJson[JsonNode](
      request = request,
      andExpect = BadRequest,
      withJsonBody = """{"errors":["invalid target for copy operation, array index out of bounds"]}""")
  }
  ...
  test("JsonPatch fails when out of bound indices are input for move") {
    ...
    server.httpRequestJson[JsonNode](
      request = request,
      andExpect = BadRequest,
      withJsonBody = """{"errors":["invalid target for move operation, array index out of bounds"]}""")
  }
