...
### <a class="anchor" name="v2" href="#v2">Note:</a>
...
For more information about the changes from v1.x see the blog post [here](https://blog.twitter.com/2015/finatra-20-the-fast-testable-scala-services-framework-that-powers-twitter).
