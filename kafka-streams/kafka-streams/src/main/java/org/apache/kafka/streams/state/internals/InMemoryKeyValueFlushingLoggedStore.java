...
//Note: This class is copied from Kafka Streams InMemoryKeyValueLoggedStore with the only changes commented with "Twitter Changed"
public class InMemoryKeyValueFlushingLoggedStore<K, V> extends WrappedStateStore.AbstractStateStore implements KeyValueStore<K, V> {
    ...
    private StoreChangeFlushingLogger<K, V> changeLogger;

    InMemoryKeyValueFlushingLoggedStore(final KeyValueStore<K, V> inner, Serde<K> keySerde, Serde<V> valueSerde) {
        super(inner);
        this.inner = inner;
    ...
    public void init(ProcessorContext context, StateStore root) {
        ...
        this.changeLogger = new StoreChangeFlushingLogger<>(inner.name(), context, serdes);
