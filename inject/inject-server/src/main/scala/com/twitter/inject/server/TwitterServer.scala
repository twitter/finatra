 ...
 */
trait TwitterServer extends App with com.twitter.server.TwitterServer with Ports with Warmup {
  ...
  private val adminAnnounceFlag =
    flag.apply[String]("admin.announce", "Address for announcing admin server")
