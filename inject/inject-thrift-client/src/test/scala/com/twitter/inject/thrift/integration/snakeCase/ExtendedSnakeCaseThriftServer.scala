...
class ExtendedSnakeCaseThriftServer extends ThriftServer {

  override val modules = Seq(ExtendedSnakeCaseThriftServerDarkTrafficFilterModule)
  ...
  override protected def configureThrift(router: ThriftRouter): Unit =
    router
      ...
      .add[ExtendedSnakeCaseController]
}
