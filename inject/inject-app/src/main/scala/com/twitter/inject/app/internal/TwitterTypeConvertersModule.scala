...
private[app] object TwitterTypeConvertersModule extends TwitterModule {
  ...
  override def configure(): Unit = {
    ...
    addFlagConverter[java.util.List[java.lang.Integer]]
    addFlagConverter[java.util.List[java.lang.Long]]
    addFlagConverter[java.util.List[java.lang.Double]]
    addFlagConverter[java.util.List[java.lang.Float]]
